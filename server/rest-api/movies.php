...
$app->get('/movies/{id}/more', function ($request, $response, $args) {
    ...
    if($movie['hasMoreInfo'] == 1) {
        ...
        $rand = array_rand($recommendedIds, 4);
        $recommended = array($recommendedIds[$rand[0]], $recommendedIds[$rand[1]], $recommendedIds[$rand[2]], $recommendedIds[$rand[3]]);
        $recommendedString = implode(',', $recommended);
